            ...
            <div key={item.cartID} className="card card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                {item.product.activeDiscount ? (
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-error">
                      {item.product.activeDiscount.discountType === 'percentage' ? (
                        <>ลด {item.product.activeDiscount.discountValue}%</>
                      ) : (
                        <>ลด ฿{item.product.activeDiscount.discountValue.toLocaleString()}</>
                      )}
                    </div>
                  </div>
                ) : (
                ...
                <p className="text-sm text-base-content/60">
                  รวม: ฿{(item.qty * (item.product.discountedPrice || item.product.price)).toLocaleString()}
                </p>
              </div>
            </div>
          ))}
